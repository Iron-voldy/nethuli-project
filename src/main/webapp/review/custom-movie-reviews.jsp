            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body p-3">
                        ...
                        <% } else { %>
                            <a href="<%= request.getContextPath() %>/manage-user-reviews?action=edit&reviewId=<%= userReview.getReviewId() %>" class="btn btn-outline-neon w-100 mb-2">
                        ...
                        <div class="review-card <%= isUserReview ? "your-review" : "" %>">
                            ...
                            <% if (isUserReview) { %>
                                <div class="review-actions">
                                    <a href="<%= request.getContextPath() %>/manage-user-reviews?action=edit&reviewId=<%= review.getReviewId() %>" class="review-action-btn btn-edit">
                                        <i class="bi bi-pencil"></i> Edit
                                    </a>
                                    <a href="<%= request.getContextPath() %>/manage-user-reviews?action=delete&reviewId=<%= review.getReviewId() %>&redirectTo=movie"
